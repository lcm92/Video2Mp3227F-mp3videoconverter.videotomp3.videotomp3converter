.class Ltv/danmaku/ijk/media/player/IjkMediaPlayer$BI1;
...
.method public constructor <init>(Ltv/danmaku/ijk/media/player/IjkMediaPlayer;Landroid/os/Looper;)V
    ...
    iput-object p2, p0, Ltv/danmaku/ijk/media/player/IjkMediaPlayer$BI1;->a:Ljava/lang/ref/WeakReference;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v0, p0, Ltv/danmaku/ijk/media/player/IjkMediaPlayer$BI1;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v0, p1}, Ldef/WW;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, v1, v2, v3}, Ltv/danmaku/ijk/media/player/APMT;->h(IIII)V
    ...
    invoke-static {v1, v2}, Ldef/WW;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p1}, Ltv/danmaku/ijk/media/player/APMT;->d(II)Z
    ...
    invoke-static {v1, v2}, Ldef/WW;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget v1, p1, Landroid/os/Message;->arg1:I

    iget p1, p1, Landroid/os/Message;->arg2:I

    invoke-virtual {v0, v1, p1}, Ltv/danmaku/ijk/media/player/APMT;->c(II)Z

    move-result p1

    if-nez p1, :cond_5

    invoke-virtual {v0}, Ltv/danmaku/ijk/media/player/APMT;->b()V
    ...
    invoke-virtual {v0, p1}, Ltv/danmaku/ijk/media/player/APMT;->g(Ldef/HM0;)V

    goto :goto_1

    :cond_7
    new-instance v1, Ldef/HM0;
    ...
    invoke-direct {v1, v3, p1}, Ldef/HM0;-><init>(Landroid/graphics/Rect;Ljava/lang/String;)V

    invoke-virtual {v0, v1}, Ltv/danmaku/ijk/media/player/APMT;->g(Ldef/HM0;)V
    ...
    :cond_9
    invoke-virtual {v0}, Ltv/danmaku/ijk/media/player/APMT;->f()V
    ...
    invoke-virtual {v0, p1}, Ltv/danmaku/ijk/media/player/APMT;->a(I)V
    ...
    :cond_f
    invoke-virtual {v0}, Ltv/danmaku/ijk/media/player/APMT;->e()V
    ...
    invoke-static {p1, v0}, Ldef/WW;->e(Ljava/lang/String;Ljava/lang/String;)V
