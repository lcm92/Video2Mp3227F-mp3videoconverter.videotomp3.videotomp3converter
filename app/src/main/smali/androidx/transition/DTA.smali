.class public Landroidx/transition/DTA;
.super Landroidx/fragment/app/QAFA;
.source "SourceFile"
...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Landroidx/fragment/app/QAFA;-><init>()V
...
.method private static C(Landroidx/transition/Transition;)Z
    ...
    invoke-static {v0}, Landroidx/fragment/app/QAFA;->l(Ljava/util/List;)Z
    ...
    invoke-static {p0}, Landroidx/fragment/app/QAFA;->l(Ljava/util/List;)Z
...
.method public A(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/transition/DTA;->q(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method public b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v2, p2}, Landroidx/transition/DTA;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    :cond_1
    invoke-static {p1}, Landroidx/transition/DTA;->C(Landroidx/transition/Transition;)Z
...
.method public c(Landroid/view/ViewGroup;Ljava/lang/Object;)V
    ...
    invoke-static {p1, p2}, Landroidx/transition/RTA;->a(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
...
.method public q(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v2, p2, p3}, Landroidx/transition/DTA;->q(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method public r(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    new-instance v0, Landroidx/transition/DTA$BD1;

    invoke-direct {v0, p0, p2, p3}, Landroidx/transition/DTA$BD1;-><init>(Landroidx/transition/DTA;Landroid/view/View;Ljava/util/ArrayList;)V

    invoke-virtual {p1, v0}, Landroidx/transition/Transition;->a(Landroidx/transition/Transition$FT1;)Landroidx/transition/Transition;
...
.method public t(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    new-instance v9, Landroidx/transition/DTA$CD1;
    ...
    invoke-direct/range {v1 .. v8}, Landroidx/transition/DTA$CD1;-><init>(Landroidx/transition/DTA;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;)V

    invoke-virtual {v0, v9}, Landroidx/transition/Transition;->a(Landroidx/transition/Transition$FT1;)Landroidx/transition/Transition;
...
.method public u(Ljava/lang/Object;Landroid/graphics/Rect;)V
    ...
    new-instance v0, Landroidx/transition/DTA$DD1;

    invoke-direct {v0, p0, p2}, Landroidx/transition/DTA$DD1;-><init>(Landroidx/transition/DTA;Landroid/graphics/Rect;)V
...
.method public v(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-virtual {p0, p2, v0}, Landroidx/fragment/app/QAFA;->k(Landroid/view/View;Landroid/graphics/Rect;)V

    new-instance p2, Landroidx/transition/DTA$AD1;

    invoke-direct {p2, p0, v0}, Landroidx/transition/DTA$AD1;-><init>(Landroidx/transition/DTA;Landroid/graphics/Rect;)V

    invoke-virtual {p1, p2}, Landroidx/transition/Transition;->Z(Landroidx/transition/Transition$ET1;)V
...
.method public z(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    invoke-static {v0, v3}, Landroidx/fragment/app/QAFA;->d(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, p3}, Landroidx/transition/DTA;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
