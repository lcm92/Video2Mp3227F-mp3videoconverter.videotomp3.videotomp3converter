.class abstract Landroidx/transition/STA;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Landroidx/transition/STA;->a:Z

    sput-boolean v1, Landroidx/transition/STA;->b:Z
    ...
    :goto_0
    sput-boolean v1, Landroidx/transition/STA;->c:Z
...
.method static a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
    ...
    invoke-static {p1, v0}, Landroidx/transition/B0TA;->j(Landroid/view/View;Landroid/graphics/Matrix;)V

    invoke-static {p0, v0}, Landroidx/transition/B0TA;->k(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    invoke-static {p1, v0, p2, p0}, Landroidx/transition/STA;->b(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
...
.method private static b(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
    ...
    sget-boolean v0, Landroidx/transition/STA;->a:Z
    ...
    :goto_0
    sget-boolean v3, Landroidx/transition/STA;->b:Z
    ...
    sget-boolean p2, Landroidx/transition/STA;->c:Z
    ...
    invoke-static {p2}, Ldef/D32;->a(Landroid/graphics/Picture;)Landroid/graphics/Bitmap;
