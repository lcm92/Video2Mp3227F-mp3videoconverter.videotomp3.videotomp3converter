...
.method public n(Landroidx/constraintlayout/widget/CWCA$AC1;Ldef/OJ0;Landroidx/constraintlayout/widget/ConstraintLayout$LayoutParams;Landroid/util/SparseArray;)V
    ...
    iget-object p3, p1, Landroidx/constraintlayout/widget/CWCA$AC1;->d:Landroidx/constraintlayout/widget/CWCA$BC1;

    iget-object v0, p3, Landroidx/constraintlayout/widget/CWCA$BC1;->e0:[I
    ...
    :cond_0
    iget-object p3, p3, Landroidx/constraintlayout/widget/CWCA$BC1;->f0:Ljava/lang/String;
    ...
    iget-object v0, p3, Landroidx/constraintlayout/widget/CWCA$BC1;->f0:Ljava/lang/String;

    invoke-direct {p0, p0, v0}, Landroidx/constraintlayout/widget/ConstraintHelper;->i(Landroid/view/View;Ljava/lang/String;)[I

    move-result-object v0

    iput-object v0, p3, Landroidx/constraintlayout/widget/CWCA$BC1;->e0:[I

    :cond_1
    :goto_0
    invoke-virtual {p2}, Ldef/OJ0;->b()V

    iget-object p3, p1, Landroidx/constraintlayout/widget/CWCA$AC1;->d:Landroidx/constraintlayout/widget/CWCA$BC1;

    iget-object p3, p3, Landroidx/constraintlayout/widget/CWCA$BC1;->e0:[I
    ...
    :goto_1
    iget-object v0, p1, Landroidx/constraintlayout/widget/CWCA$AC1;->d:Landroidx/constraintlayout/widget/CWCA$BC1;

    iget-object v0, v0, Landroidx/constraintlayout/widget/CWCA$BC1;->e0:[I
    ...
    invoke-virtual {p2, v0}, Ldef/OJ0;->a(Ldef/JQ;)V
...
.method public s(Ldef/KQ;Ldef/MJ0;Landroid/util/SparseArray;)V
    .locals 1

    invoke-interface {p2}, Ldef/MJ0;->b()V
    ...
    invoke-interface {p2, v0}, Ldef/MJ0;->a(Ldef/JQ;)V
...
.method public t(Landroidx/constraintlayout/widget/ConstraintLayout;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintHelper;->d:Ldef/MJ0;
    ...
    :cond_1
    invoke-interface {v0}, Ldef/MJ0;->b()V
    ...
    iget-object v1, p0, Landroidx/constraintlayout/widget/ConstraintHelper;->d:Ldef/MJ0;

    invoke-virtual {p1, v2}, Landroidx/constraintlayout/widget/ConstraintLayout;->i(Landroid/view/View;)Ldef/JQ;

    move-result-object v2

    invoke-interface {v1, v2}, Ldef/MJ0;->a(Ldef/JQ;)V
    ...
    iget-object p1, p1, Landroidx/constraintlayout/widget/ConstraintLayout;->c:Ldef/KQ;

    invoke-interface {v0, p1}, Ldef/MJ0;->c(Ldef/KQ;)V
