...
.method public static declared-synchronized h()V
    ...
    .line 19
    iput-object v2, v1, Landroidx/appcompat/widget/f;->a:Landroidx/appcompat/widget/s;

    .line 21
    sget-object v1, Landroidx/appcompat/widget/f;->c:Landroidx/appcompat/widget/f;

    .line 23
    iget-object v1, v1, Landroidx/appcompat/widget/f;->a:Landroidx/appcompat/widget/s;
    ...
    .line 30
    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/s;->u(Landroidx/appcompat/widget/s$f;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method static i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/z;[I)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2}, Landroidx/appcompat/widget/s;->w(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/z;[I)V
...
.method public declared-synchronized c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Landroidx/appcompat/widget/f;->a:Landroidx/appcompat/widget/s;

    .line 4
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/s;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized d(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 4
    invoke-virtual {v0, p1, p2, p3}, Landroidx/appcompat/widget/s;->k(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 4
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/s;->m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public declared-synchronized g(Landroid/content/Context;)V
    ...
    .line 4
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/s;->s(Landroid/content/Context;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
