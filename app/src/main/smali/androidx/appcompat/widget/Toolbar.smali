...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/widget/Toolbar$DT1;,
        Landroidx/appcompat/widget/Toolbar$SavedState;,
        Landroidx/appcompat/widget/Toolbar$LayoutParams;,
        Landroidx/appcompat/widget/Toolbar$ET1;
    }
.end annotation
...
.field private H:Landroidx/appcompat/widget/UWAA;
...
.field U:Landroidx/appcompat/widget/Toolbar$ET1;

.field private final V:Landroidx/appcompat/widget/ActionMenuView$DA1;

.field private W:Landroidx/appcompat/widget/C0WAA;
...
.field private b0:Landroidx/appcompat/widget/Toolbar$DT1;

.field private c:Landroid/widget/TextView;

.field private c0:Landroidx/appcompat/view/menu/JMVA$AJ1;

.field private d:Landroid/widget/ImageButton;

.field private d0:Landroidx/appcompat/view/menu/EMVA$AE1;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance v0, Landroidx/appcompat/widget/Toolbar$AT1;

    invoke-direct {v0, p0}, Landroidx/appcompat/widget/Toolbar$AT1;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->V:Landroidx/appcompat/widget/ActionMenuView$DA1;

    new-instance v0, Landroidx/appcompat/widget/Toolbar$BT1;

    invoke-direct {v0, p0}, Landroidx/appcompat/widget/Toolbar$BT1;-><init>(Landroidx/appcompat/widget/Toolbar;)V
    ...
    invoke-static {v0, p2, v3, p3, v8}, Landroidx/appcompat/widget/B0WAA;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/B0WAA;
    ...
    invoke-virtual {v0, p1, v8}, Landroidx/appcompat/widget/B0WAA;->n(II)I
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/B0WAA;->l(II)I
    ...
    invoke-virtual {v0, p1, v8}, Landroidx/appcompat/widget/B0WAA;->e(II)I
    ...
    invoke-virtual {v0, p2, p1}, Landroidx/appcompat/widget/B0WAA;->e(II)I
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/B0WAA;->e(II)I
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/B0WAA;->f(II)I
    ...
    invoke-virtual {v0, p3, p2}, Landroidx/appcompat/widget/B0WAA;->e(II)I

    move-result p3

    sget v1, Landroidx/appcompat/R$styleable;->r3:I

    invoke-virtual {v0, v1, v8}, Landroidx/appcompat/widget/B0WAA;->f(II)I

    move-result v1

    sget v2, Landroidx/appcompat/R$styleable;->s3:I

    invoke-virtual {v0, v2, v8}, Landroidx/appcompat/widget/B0WAA;->f(II)I

    move-result v2

    invoke-direct {p0}, Landroidx/appcompat/widget/Toolbar;->h()V

    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar;->H:Landroidx/appcompat/widget/UWAA;

    invoke-virtual {v3, v1, v2}, Landroidx/appcompat/widget/UWAA;->e(II)V
    ...
    :cond_5
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->H:Landroidx/appcompat/widget/UWAA;

    invoke-virtual {v1, p1, p3}, Landroidx/appcompat/widget/UWAA;->g(II)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/B0WAA;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/B0WAA;->p(I)Ljava/lang/CharSequence;
...
.method private b(Ljava/util/List;I)V
    ...
    invoke-static {p2, v4}, Ldef/CI0;->b(II)I
...
.method private h()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->H:Landroidx/appcompat/widget/UWAA;

    if-nez v0, :cond_0

    new-instance v0, Landroidx/appcompat/widget/UWAA;

    invoke-direct {v0}, Landroidx/appcompat/widget/UWAA;-><init>()V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->H:Landroidx/appcompat/widget/UWAA;
...
.method private j()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/ActionMenuView;->N()Landroidx/appcompat/view/menu/EMVA;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->b0:Landroidx/appcompat/widget/Toolbar$DT1;

    if-nez v1, :cond_0

    new-instance v1, Landroidx/appcompat/widget/Toolbar$DT1;

    invoke-direct {v1, p0}, Landroidx/appcompat/widget/Toolbar$DT1;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->b0:Landroidx/appcompat/widget/Toolbar$DT1;
    ...
    invoke-virtual {v0, v1, v2}, Landroidx/appcompat/view/menu/EMVA;->c(Landroidx/appcompat/view/menu/JMVA;Landroid/content/Context;)V
...
.method private k()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->V:Landroidx/appcompat/widget/ActionMenuView$DA1;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/ActionMenuView;->setOnMenuItemClickListener(Landroidx/appcompat/widget/ActionMenuView$DA1;)V

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->a:Landroidx/appcompat/widget/ActionMenuView;

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->c0:Landroidx/appcompat/view/menu/JMVA$AJ1;

    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->d0:Landroidx/appcompat/view/menu/EMVA$AE1;

    invoke-virtual {v0, v1, v2}, Landroidx/appcompat/widget/ActionMenuView;->O(Landroidx/appcompat/view/menu/JMVA$AJ1;Landroidx/appcompat/view/menu/EMVA$AE1;)V
...
.method private s(Landroid/view/View;)I
    ...
    invoke-static {p1}, Ldef/AY0;->b(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method public H(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/UWAA;->g(II)V

    return-void
.end method

.method public I(Landroidx/appcompat/view/menu/EMVA;Landroidx/appcompat/widget/ActionMenuPresenter;)V
    .locals 3
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/EMVA;->Q(Landroidx/appcompat/view/menu/JMVA;)V
    ...
    :cond_2
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->b0:Landroidx/appcompat/widget/Toolbar$DT1;

    if-nez v0, :cond_3

    new-instance v0, Landroidx/appcompat/widget/Toolbar$DT1;

    invoke-direct {v0, p0}, Landroidx/appcompat/widget/Toolbar$DT1;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->b0:Landroidx/appcompat/widget/Toolbar$DT1;
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/view/menu/EMVA;->c(Landroidx/appcompat/view/menu/JMVA;Landroid/content/Context;)V

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->b0:Landroidx/appcompat/widget/Toolbar$DT1;

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/view/menu/EMVA;->c(Landroidx/appcompat/view/menu/JMVA;Landroid/content/Context;)V
    ...
    invoke-virtual {p2, p1, v1}, Landroidx/appcompat/widget/ActionMenuPresenter;->j(Landroid/content/Context;Landroidx/appcompat/view/menu/EMVA;)V

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar;->b0:Landroidx/appcompat/widget/Toolbar$DT1;

    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->j:Landroid/content/Context;

    invoke-virtual {p1, v2, v1}, Landroidx/appcompat/widget/Toolbar$DT1;->j(Landroid/content/Context;Landroidx/appcompat/view/menu/EMVA;)V

    invoke-virtual {p2, v0}, Landroidx/appcompat/widget/ActionMenuPresenter;->e(Z)V

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar;->b0:Landroidx/appcompat/widget/Toolbar$DT1;

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/Toolbar$DT1;->e(Z)V
...
.method public J(Landroidx/appcompat/view/menu/JMVA$AJ1;Landroidx/appcompat/view/menu/EMVA$AE1;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->c0:Landroidx/appcompat/view/menu/JMVA$AJ1;

    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar;->d0:Landroidx/appcompat/view/menu/EMVA$AE1;

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->a:Landroidx/appcompat/widget/ActionMenuView;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/ActionMenuView;->O(Landroidx/appcompat/view/menu/JMVA$AJ1;Landroidx/appcompat/view/menu/EMVA$AE1;)V
...
.method public e()V
    ...
    :cond_0
    iget-object v0, v0, Landroidx/appcompat/widget/Toolbar$DT1;->b:Landroidx/appcompat/view/menu/GMVA;

    :goto_0
    if-eqz v0, :cond_1

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/GMVA;->collapseActionView()Z
...
.method g()V
    ...
    new-instance v1, Landroidx/appcompat/widget/Toolbar$CT1;

    invoke-direct {v1, p0}, Landroidx/appcompat/widget/Toolbar$CT1;-><init>(Landroidx/appcompat/widget/Toolbar;)V
...
.method public getContentInsetEnd()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/UWAA;->a()I
...
.method public getContentInsetLeft()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/UWAA;->b()I
...
.method public getContentInsetRight()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/UWAA;->c()I
...
.method public getContentInsetStart()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/UWAA;->d()I
...
.method public getCurrentContentInsetEnd()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/EMVA;->hasVisibleItems()Z
...
.method public getWrapper()Ldef/NX;
    .locals 2

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->W:Landroidx/appcompat/widget/C0WAA;

    if-nez v0, :cond_0

    new-instance v0, Landroidx/appcompat/widget/C0WAA;

    const/4 v1, 0x1

    invoke-direct {v0, p0, v1}, Landroidx/appcompat/widget/C0WAA;-><init>(Landroidx/appcompat/widget/Toolbar;Z)V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->W:Landroidx/appcompat/widget/C0WAA;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Ldef/L92;->C(Landroid/view/View;)I
...
.method protected onMeasure(II)V
    ...
    invoke-static/range {p0 .. p0}, Ldef/KA2;->b(Landroid/view/View;)Z
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->b0:Landroidx/appcompat/widget/Toolbar$DT1;
...
.method public onRtlPropertiesChanged(I)V
    ...
    :goto_0
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/UWAA;->f(Z)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, v1, Landroidx/appcompat/widget/Toolbar$DT1;->b:Landroidx/appcompat/view/menu/GMVA;
...
.method public setOnMenuItemClickListener(Landroidx/appcompat/widget/Toolbar$ET1;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->U:Landroidx/appcompat/widget/Toolbar$ET1;
