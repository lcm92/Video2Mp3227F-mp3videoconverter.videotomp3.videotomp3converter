...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/widget/ListPopupWindow$EL1;,
        Landroidx/appcompat/widget/ListPopupWindow$FL1;,
        Landroidx/appcompat/widget/ListPopupWindow$GL1;,
        Landroidx/appcompat/widget/ListPopupWindow$CL1;,
        Landroidx/appcompat/widget/ListPopupWindow$DL1;
    }
.end annotation
...
.field final K:Landroidx/appcompat/widget/ListPopupWindow$GL1;

.field private final L:Landroidx/appcompat/widget/ListPopupWindow$FL1;

.field private final M:Landroidx/appcompat/widget/ListPopupWindow$EL1;

.field private final N:Landroidx/appcompat/widget/ListPopupWindow$CL1;
...
.field c:Landroidx/appcompat/widget/PWAA;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    new-instance v1, Landroidx/appcompat/widget/ListPopupWindow$GL1;

    invoke-direct {v1, p0}, Landroidx/appcompat/widget/ListPopupWindow$GL1;-><init>(Landroidx/appcompat/widget/ListPopupWindow;)V

    iput-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->K:Landroidx/appcompat/widget/ListPopupWindow$GL1;

    new-instance v1, Landroidx/appcompat/widget/ListPopupWindow$FL1;

    invoke-direct {v1, p0}, Landroidx/appcompat/widget/ListPopupWindow$FL1;-><init>(Landroidx/appcompat/widget/ListPopupWindow;)V

    iput-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->L:Landroidx/appcompat/widget/ListPopupWindow$FL1;

    new-instance v1, Landroidx/appcompat/widget/ListPopupWindow$EL1;

    invoke-direct {v1, p0}, Landroidx/appcompat/widget/ListPopupWindow$EL1;-><init>(Landroidx/appcompat/widget/ListPopupWindow;)V

    iput-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->M:Landroidx/appcompat/widget/ListPopupWindow$EL1;

    new-instance v1, Landroidx/appcompat/widget/ListPopupWindow$CL1;

    invoke-direct {v1, p0}, Landroidx/appcompat/widget/ListPopupWindow$CL1;-><init>(Landroidx/appcompat/widget/ListPopupWindow;)V

    iput-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->N:Landroidx/appcompat/widget/ListPopupWindow$CL1;
...
.method private N(Z)V
    ...
    invoke-static {v0, p1}, Ldef/JT0;->a(Landroid/widget/PopupWindow;Z)V
...
.method private q()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:Landroidx/appcompat/widget/PWAA;
    ...
    new-instance v5, Landroidx/appcompat/widget/ListPopupWindow$AL1;

    invoke-direct {v5, p0}, Landroidx/appcompat/widget/ListPopupWindow$AL1;-><init>(Landroidx/appcompat/widget/ListPopupWindow;)V
    ...
    invoke-virtual {p0, v0, v5}, Landroidx/appcompat/widget/ListPopupWindow;->s(Landroid/content/Context;Z)Landroidx/appcompat/widget/PWAA;

    move-result-object v5

    iput-object v5, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:Landroidx/appcompat/widget/PWAA;

    iget-object v6, p0, Landroidx/appcompat/widget/ListPopupWindow;->H:Landroid/graphics/drawable/Drawable;

    if-eqz v6, :cond_0

    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/PWAA;->setSelector(Landroid/graphics/drawable/Drawable;)V

    :cond_0
    iget-object v5, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:Landroidx/appcompat/widget/PWAA;
    ...
    new-instance v6, Landroidx/appcompat/widget/ListPopupWindow$BL1;

    invoke-direct {v6, p0}, Landroidx/appcompat/widget/ListPopupWindow$BL1;-><init>(Landroidx/appcompat/widget/ListPopupWindow;)V

    invoke-virtual {v5, v6}, Landroid/widget/AdapterView;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    iget-object v5, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:Landroidx/appcompat/widget/PWAA;

    iget-object v6, p0, Landroidx/appcompat/widget/ListPopupWindow;->M:Landroidx/appcompat/widget/ListPopupWindow$EL1;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:Landroidx/appcompat/widget/PWAA;
    ...
    invoke-virtual/range {v6 .. v11}, Landroidx/appcompat/widget/PWAA;->d(IIIII)I

    move-result v1

    if-lez v1, :cond_e

    iget-object v2, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:Landroidx/appcompat/widget/PWAA;

    invoke-virtual {v2}, Landroid/view/View;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:Landroidx/appcompat/widget/PWAA;
...
.method private u(Landroid/view/View;IZ)I
    ...
    invoke-static {v0, p1, p2, p3}, Ldef/IT0;->a(Landroid/widget/PopupWindow;Landroid/view/View;IZ)I
...
.method public P(I)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/PWAA;->setListSelectionHidden(Z)V
...
.method public c()V
    ...
    invoke-static {v2, v3}, Ldef/RC1;->b(Landroid/widget/PopupWindow;I)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->L:Landroidx/appcompat/widget/ListPopupWindow$FL1;
    ...
    invoke-static {v0, v1}, Ldef/RC1;->a(Landroid/widget/PopupWindow;Z)V
    ...
    invoke-static {v0, v1}, Ldef/HT0;->a(Landroid/widget/PopupWindow;Landroid/graphics/Rect;)V
    ...
    invoke-static {v0, v1, v2, v3, v4}, Ldef/RC1;->c(Landroid/widget/PopupWindow;Landroid/view/View;III)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/PWAA;->isInTouchMode()Z
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->N:Landroidx/appcompat/widget/ListPopupWindow$CL1;
...
.method public dismiss()V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:Landroidx/appcompat/widget/PWAA;

    iget-object v0, p0, Landroidx/appcompat/widget/ListPopupWindow;->P:Landroid/os/Handler;

    iget-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->K:Landroidx/appcompat/widget/ListPopupWindow$GL1;
...
.method public p(Landroid/widget/ListAdapter;)V
    ...
    new-instance v0, Landroidx/appcompat/widget/ListPopupWindow$DL1;

    invoke-direct {v0, p0}, Landroidx/appcompat/widget/ListPopupWindow$DL1;-><init>(Landroidx/appcompat/widget/ListPopupWindow;)V
    ...
    :cond_2
    iget-object p1, p0, Landroidx/appcompat/widget/ListPopupWindow;->c:Landroidx/appcompat/widget/PWAA;
...
.method s(Landroid/content/Context;Z)Landroidx/appcompat/widget/PWAA;
    ...
    new-instance v0, Landroidx/appcompat/widget/PWAA;

    invoke-direct {v0, p1, p2}, Landroidx/appcompat/widget/PWAA;-><init>(Landroid/content/Context;Z)V
