...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroidx/appcompat/widget/ActivityChooserView$FA1;,
        Landroidx/appcompat/widget/ActivityChooserView$GA1;
    }
.end annotation
...
.field final a:Landroidx/appcompat/widget/ActivityChooserView$FA1;

.field private final b:Landroidx/appcompat/widget/ActivityChooserView$GA1;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance v0, Landroidx/appcompat/widget/ActivityChooserView$AA1;

    invoke-direct {v0, p0}, Landroidx/appcompat/widget/ActivityChooserView$AA1;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V

    iput-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->k:Landroid/database/DataSetObserver;

    new-instance v0, Landroidx/appcompat/widget/ActivityChooserView$BA1;

    invoke-direct {v0, p0}, Landroidx/appcompat/widget/ActivityChooserView$BA1;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V
    ...
    new-instance p3, Landroidx/appcompat/widget/ActivityChooserView$GA1;

    invoke-direct {p3, p0}, Landroidx/appcompat/widget/ActivityChooserView$GA1;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V

    iput-object p3, p0, Landroidx/appcompat/widget/ActivityChooserView;->b:Landroidx/appcompat/widget/ActivityChooserView$GA1;
    ...
    new-instance p3, Landroidx/appcompat/widget/ActivityChooserView$CA1;

    invoke-direct {p3, p0}, Landroidx/appcompat/widget/ActivityChooserView$CA1;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V

    invoke-virtual {v0, p3}, Landroid/view/View;->setAccessibilityDelegate(Landroid/view/View$AccessibilityDelegate;)V

    new-instance p3, Landroidx/appcompat/widget/ActivityChooserView$DA1;

    invoke-direct {p3, p0, v0}, Landroidx/appcompat/widget/ActivityChooserView$DA1;-><init>(Landroidx/appcompat/widget/ActivityChooserView;Landroid/view/View;)V
    ...
    new-instance p2, Landroidx/appcompat/widget/ActivityChooserView$FA1;

    invoke-direct {p2, p0}, Landroidx/appcompat/widget/ActivityChooserView$FA1;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActivityChooserView;->a:Landroidx/appcompat/widget/ActivityChooserView$FA1;

    new-instance p3, Landroidx/appcompat/widget/ActivityChooserView$EA1;

    invoke-direct {p3, p0}, Landroidx/appcompat/widget/ActivityChooserView$EA1;-><init>(Landroidx/appcompat/widget/ActivityChooserView;)V
...
.method d(I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActivityChooserView;->a:Landroidx/appcompat/widget/ActivityChooserView$FA1;

    invoke-virtual {p1}, Landroidx/appcompat/widget/ActivityChooserView$FA1;->b()Landroidx/appcompat/widget/CWAA;
...
.method e()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->a:Landroidx/appcompat/widget/ActivityChooserView$FA1;

    invoke-virtual {v0}, Landroidx/appcompat/widget/ActivityChooserView$FA1;->getCount()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/ActivityChooserView$FA1;->a()I

    move-result v0

    iget-object v3, p0, Landroidx/appcompat/widget/ActivityChooserView;->a:Landroidx/appcompat/widget/ActivityChooserView$FA1;

    invoke-virtual {v3}, Landroidx/appcompat/widget/ActivityChooserView$FA1;->d()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/ActivityChooserView$FA1;->c()Landroid/content/pm/ResolveInfo;
...
.method public getDataModel()Landroidx/appcompat/widget/CWAA;
    .locals 1

    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->a:Landroidx/appcompat/widget/ActivityChooserView$FA1;

    invoke-virtual {v0}, Landroidx/appcompat/widget/ActivityChooserView$FA1;->b()Landroidx/appcompat/widget/CWAA;
...
.method getListPopupWindow()Landroidx/appcompat/widget/ListPopupWindow;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ActivityChooserView;->a:Landroidx/appcompat/widget/ActivityChooserView$FA1;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ActivityChooserView;->b:Landroidx/appcompat/widget/ActivityChooserView$GA1;
...
.method public setActivityChooserModel(Landroidx/appcompat/widget/CWAA;)V
    .locals 1

    iget-object v0, p0, Landroidx/appcompat/widget/ActivityChooserView;->a:Landroidx/appcompat/widget/ActivityChooserView$FA1;

    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/ActivityChooserView$FA1;->f(Landroidx/appcompat/widget/CWAA;)V
...
.method public setProvider(Ldef/R1;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/ActivityChooserView;->j:Ldef/R1;
