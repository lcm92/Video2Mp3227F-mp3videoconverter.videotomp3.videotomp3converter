...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;,
...
.field private I:Ldef/SC2;

.field private J:Ldef/SC2;

.field private K:Ldef/SC2;

.field private L:Ldef/SC2;

.field private M:Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;
...
.field private final S:Ldef/L51;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, Ldef/SC2;->b:Ldef/SC2;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->I:Ldef/SC2;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J:Ldef/SC2;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K:Ldef/SC2;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->L:Ldef/SC2;

    new-instance p2, Landroidx/appcompat/widget/ActionBarOverlayLayout$AA1;

    invoke-direct {p2, p0}, Landroidx/appcompat/widget/ActionBarOverlayLayout$AA1;-><init>(Landroidx/appcompat/widget/ActionBarOverlayLayout;)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->P:Landroid/animation/AnimatorListenerAdapter;

    new-instance p2, Landroidx/appcompat/widget/ActionBarOverlayLayout$BA1;

    invoke-direct {p2, p0}, Landroidx/appcompat/widget/ActionBarOverlayLayout$BA1;-><init>(Landroidx/appcompat/widget/ActionBarOverlayLayout;)V

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->Q:Ljava/lang/Runnable;

    new-instance p2, Landroidx/appcompat/widget/ActionBarOverlayLayout$CA1;

    invoke-direct {p2, p0}, Landroidx/appcompat/widget/ActionBarOverlayLayout$CA1;-><init>(Landroidx/appcompat/widget/ActionBarOverlayLayout;)V
    ...
    new-instance p1, Ldef/L51;

    invoke-direct {p1, p0}, Ldef/L51;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->S:Ldef/L51;
...
.method private t(Landroid/view/View;)Ldef/NX;
    .locals 3
...
.method public a(Landroid/view/Menu;Landroidx/appcompat/view/menu/JMVA$AJ1;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:Ldef/NX;

    invoke-interface {v0, p1, p2}, Ldef/NX;->a(Landroid/view/Menu;Landroidx/appcompat/view/menu/JMVA$AJ1;)V
...
.method public b()Z
    ...
    invoke-interface {v0}, Ldef/NX;->b()Z
...
.method public c()V
    ...
    invoke-interface {v0}, Ldef/NX;->c()V
...
.method public d()Z
    ...
    invoke-interface {v0}, Ldef/NX;->d()Z
...
.method public e()Z
    ...
    invoke-interface {v0}, Ldef/NX;->e()Z
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->S:Ldef/L51;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Ldef/NX;->getTitle()Ljava/lang/CharSequence;
...
.method public h(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:Ldef/NX;

    invoke-interface {p1}, Ldef/NX;->v()V
    ...
    invoke-interface {p1}, Ldef/NX;->u()V
...
.method public i()V
    ...
    invoke-interface {v0}, Ldef/NX;->h()V
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p1, p0}, Ldef/SC2;->x(Landroid/view/WindowInsets;Landroid/view/View;)Ldef/SC2;
    ...
    invoke-static {p0, p1, v1}, Ldef/L92;->f(Landroid/view/View;Ldef/SC2;Landroid/graphics/Rect;)Ldef/SC2;
    ...
    invoke-virtual {p1, v2, v3, v4, v1}, Ldef/SC2;->n(IIII)Ldef/SC2;

    move-result-object v1

    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->I:Ldef/SC2;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J:Ldef/SC2;

    invoke-virtual {v2, v1}, Ldef/SC2;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->I:Ldef/SC2;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->J:Ldef/SC2;
    ...
    :cond_2
    invoke-virtual {p1}, Ldef/SC2;->a()Ldef/SC2;
    ...
    invoke-virtual {p1}, Ldef/SC2;->b()Ldef/SC2;
...
.method protected onMeasure(II)V
    ...
    invoke-static {p0}, Ldef/L92;->M(Landroid/view/View;)I
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->I:Ldef/SC2;

    iput-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K:Ldef/SC2;
    ...
    invoke-virtual {v6, v2, v5, v2, v2}, Ldef/SC2;->n(IIII)Ldef/SC2;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K:Ldef/SC2;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K:Ldef/SC2;

    invoke-virtual {v4}, Ldef/SC2;->l()I

    move-result v4

    add-int/2addr v4, v5

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K:Ldef/SC2;

    invoke-virtual {v5}, Ldef/SC2;->k()I

    move-result v5

    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K:Ldef/SC2;

    invoke-virtual {v6}, Ldef/SC2;->i()I

    move-result v6

    invoke-static {v2, v4, v5, v6}, Ldef/HO0;->b(IIII)Ldef/HO0;

    move-result-object v2

    new-instance v4, Ldef/SC2$BS1;

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K:Ldef/SC2;

    invoke-direct {v4, v5}, Ldef/SC2$BS1;-><init>(Ldef/SC2;)V

    invoke-virtual {v4, v2}, Ldef/SC2$BS1;->c(Ldef/HO0;)Ldef/SC2$BS1;

    move-result-object v2

    invoke-virtual {v2}, Ldef/SC2$BS1;->a()Ldef/SC2;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->L:Ldef/SC2;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K:Ldef/SC2;

    invoke-virtual {v2, v4}, Ldef/SC2;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_5

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->K:Ldef/SC2;

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->L:Ldef/SC2;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->c:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v4, v2}, Ldef/L92;->g(Landroid/view/View;Ldef/SC2;)Ldef/SC2;
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->M:Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;

    if-eqz p1, :cond_0

    invoke-interface {p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;->e()V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-interface {p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;->b()V
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    invoke-interface {p1, v3}, Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;->c(Z)V
    ...
    invoke-interface {p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;->d()V
    ...
    invoke-interface {p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;->a()V
...
.method protected onWindowVisibilityChanged(I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->M:Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;->onWindowVisibilityChanged(I)V
...
.method public setActionBarVisibilityCallback(Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->M:Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;
    ...
    invoke-interface {p1, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout$DA1;->onWindowVisibilityChanged(I)V
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Ldef/NX;->setIcon(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Ldef/NX;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Ldef/NX;->m(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Ldef/NX;->setWindowCallback(Landroid/view/Window$Callback;)V
...
.method z()V
    ...
    invoke-direct {p0, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->t(Landroid/view/View;)Ldef/NX;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:Ldef/NX;
