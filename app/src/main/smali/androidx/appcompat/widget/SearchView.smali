...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/widget/SearchView$NS1;,
        Landroidx/appcompat/widget/SearchView$SearchAutoComplete;,
        Landroidx/appcompat/widget/SearchView$OS1;,
        Landroidx/appcompat/widget/SearchView$SavedState;,
        Landroidx/appcompat/widget/SearchView$MS1;,
        Landroidx/appcompat/widget/SearchView$KS1;,
        Landroidx/appcompat/widget/SearchView$LS1;
    }
.end annotation


# static fields
.field static final B0:Landroidx/appcompat/widget/SearchView$NS1;
...
.field private M:Landroidx/appcompat/widget/SearchView$OS1;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Landroidx/appcompat/widget/SearchView$NS1;

    invoke-direct {v0}, Landroidx/appcompat/widget/SearchView$NS1;-><init>()V
    ...
    :goto_0
    sput-object v0, Landroidx/appcompat/widget/SearchView;->B0:Landroidx/appcompat/widget/SearchView$NS1;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance v1, Landroidx/appcompat/widget/SearchView$BS1;

    invoke-direct {v1, v0}, Landroidx/appcompat/widget/SearchView$BS1;-><init>(Landroidx/appcompat/widget/SearchView;)V

    iput-object v1, v0, Landroidx/appcompat/widget/SearchView;->s0:Ljava/lang/Runnable;

    new-instance v1, Landroidx/appcompat/widget/SearchView$CS1;

    invoke-direct {v1, v0}, Landroidx/appcompat/widget/SearchView$CS1;-><init>(Landroidx/appcompat/widget/SearchView;)V
    ...
    new-instance v1, Landroidx/appcompat/widget/SearchView$FS1;

    invoke-direct {v1, v0}, Landroidx/appcompat/widget/SearchView$FS1;-><init>(Landroidx/appcompat/widget/SearchView;)V

    iput-object v1, v0, Landroidx/appcompat/widget/SearchView;->v0:Landroid/view/View$OnClickListener;

    new-instance v2, Landroidx/appcompat/widget/SearchView$GS1;

    invoke-direct {v2, v0}, Landroidx/appcompat/widget/SearchView$GS1;-><init>(Landroidx/appcompat/widget/SearchView;)V

    iput-object v2, v0, Landroidx/appcompat/widget/SearchView;->w0:Landroid/view/View$OnKeyListener;

    new-instance v2, Landroidx/appcompat/widget/SearchView$HS1;

    invoke-direct {v2, v0}, Landroidx/appcompat/widget/SearchView$HS1;-><init>(Landroidx/appcompat/widget/SearchView;)V

    iput-object v2, v0, Landroidx/appcompat/widget/SearchView;->x0:Landroid/widget/TextView$OnEditorActionListener;

    new-instance v3, Landroidx/appcompat/widget/SearchView$IS1;

    invoke-direct {v3, v0}, Landroidx/appcompat/widget/SearchView$IS1;-><init>(Landroidx/appcompat/widget/SearchView;)V

    iput-object v3, v0, Landroidx/appcompat/widget/SearchView;->y0:Landroid/widget/AdapterView$OnItemClickListener;

    new-instance v4, Landroidx/appcompat/widget/SearchView$JS1;

    invoke-direct {v4, v0}, Landroidx/appcompat/widget/SearchView$JS1;-><init>(Landroidx/appcompat/widget/SearchView;)V

    iput-object v4, v0, Landroidx/appcompat/widget/SearchView;->z0:Landroid/widget/AdapterView$OnItemSelectedListener;

    new-instance v5, Landroidx/appcompat/widget/SearchView$AS1;

    invoke-direct {v5, v0}, Landroidx/appcompat/widget/SearchView$AS1;-><init>(Landroidx/appcompat/widget/SearchView;)V
    ...
    invoke-static {v7, v8, v5, v9, v6}, Landroidx/appcompat/widget/B0WAA;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/B0WAA;
    ...
    invoke-virtual {v5, v8, v9}, Landroidx/appcompat/widget/B0WAA;->n(II)I
    ...
    invoke-virtual {v5, v9}, Landroidx/appcompat/widget/B0WAA;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v9

    invoke-static {v8, v9}, Ldef/L92;->s0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    sget v8, Landroidx/appcompat/R$styleable;->z2:I

    invoke-virtual {v5, v8}, Landroidx/appcompat/widget/B0WAA;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    invoke-static {v10, v8}, Ldef/L92;->s0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    sget v9, Landroidx/appcompat/R$string;->o:I

    invoke-virtual {v8, v9}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v8

    invoke-static {v11, v8}, Ldef/C12;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v5, v8, v6}, Landroidx/appcompat/widget/B0WAA;->n(II)I
    ...
    new-instance v1, Landroidx/appcompat/widget/SearchView$DS1;

    invoke-direct {v1, v0}, Landroidx/appcompat/widget/SearchView$DS1;-><init>(Landroidx/appcompat/widget/SearchView;)V
    ...
    invoke-virtual {v5, v1, v2}, Landroidx/appcompat/widget/B0WAA;->a(IZ)Z
    ...
    invoke-virtual {v5, v1, v2}, Landroidx/appcompat/widget/B0WAA;->f(II)I
    ...
    invoke-virtual {v5, v1}, Landroidx/appcompat/widget/B0WAA;->p(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v5, v1, v2}, Landroidx/appcompat/widget/B0WAA;->k(II)I
    ...
    invoke-virtual {v5}, Landroidx/appcompat/widget/B0WAA;->w()V
    ...
    new-instance v2, Landroidx/appcompat/widget/SearchView$ES1;

    invoke-direct {v2, v0}, Landroidx/appcompat/widget/SearchView$ES1;-><init>(Landroidx/appcompat/widget/SearchView;)V
...
.method private D(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, v3}, Landroidx/appcompat/widget/WWAA;->o(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private Q(IILjava/lang/String;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SearchView;->f0:Ldef/OU;

    invoke-virtual {v0}, Ldef/OU;->b()Landroid/database/Cursor;
...
.method private c0(I)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SearchView;->f0:Ldef/OU;

    invoke-virtual {v1}, Ldef/OU;->b()Landroid/database/Cursor;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SearchView;->f0:Ldef/OU;

    invoke-virtual {p1, v1}, Ldef/OU;->c(Landroid/database/Cursor;)Ljava/lang/CharSequence;
...
.method private getPreferredHeight()I
    ...
    sget v1, Landroidx/appcompat/R$dimen;->e:I
...
.method private getPreferredWidth()I
    ...
    sget v1, Landroidx/appcompat/R$dimen;->f:I
...
.method private h0()V
    ...
    invoke-virtual {v0, v1}, Ldef/OU;->a(Landroid/database/Cursor;)V
    ...
    new-instance v0, Landroidx/appcompat/widget/WWAA;
    ...
    invoke-direct {v0, v1, p0, v3, v4}, Landroidx/appcompat/widget/WWAA;-><init>(Landroid/content/Context;Landroidx/appcompat/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V

    iput-object v0, p0, Landroidx/appcompat/widget/SearchView;->f0:Ldef/OU;
    ...
    check-cast v0, Landroidx/appcompat/widget/WWAA;
    ...
    :cond_2
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/WWAA;->x(I)V
...
.method B()V
    ...
    invoke-static {p0}, Ldef/KA2;->b(Landroid/view/View;)Z
    ...
    sget v4, Landroidx/appcompat/R$dimen;->c:I

    invoke-virtual {v0, v4}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v4

    sget v5, Landroidx/appcompat/R$dimen;->d:I
...
.method H()V
    ...
    invoke-static {v0}, Ldef/PN1;->a(Landroidx/appcompat/widget/SearchView$SearchAutoComplete;)V

    goto :goto_0

    :cond_0
    sget-object v0, Landroidx/appcompat/widget/SearchView;->B0:Landroidx/appcompat/widget/SearchView$NS1;

    iget-object v1, p0, Landroidx/appcompat/widget/SearchView;->D:Landroidx/appcompat/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/SearchView$NS1;->b(Landroid/widget/AutoCompleteTextView;)V

    iget-object v1, p0, Landroidx/appcompat/widget/SearchView;->D:Landroidx/appcompat/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/SearchView$NS1;->a(Landroid/widget/AutoCompleteTextView;)V
...
.method public getSuggestionsAdapter()Ldef/OU;
    .locals 1
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SearchView;->M:Landroidx/appcompat/widget/SearchView$OS1;

    if-nez p1, :cond_0

    new-instance p1, Landroidx/appcompat/widget/SearchView$OS1;
    ...
    invoke-direct {p1, p2, p3, p4}, Landroidx/appcompat/widget/SearchView$OS1;-><init>(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/View;)V

    iput-object p1, p0, Landroidx/appcompat/widget/SearchView;->M:Landroidx/appcompat/widget/SearchView$OS1;
    ...
    invoke-virtual {p1, p2, p3}, Landroidx/appcompat/widget/SearchView$OS1;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public setOnCloseListener(Landroidx/appcompat/widget/SearchView$KS1;)V
    .locals 0
...
.method public setOnQueryTextListener(Landroidx/appcompat/widget/SearchView$LS1;)V
    .locals 0
...
.method public setOnSuggestionListener(Landroidx/appcompat/widget/SearchView$MS1;)V
    .locals 0
...
.method public setQueryRefinementEnabled(Z)V
    ...
    instance-of v1, v0, Landroidx/appcompat/widget/WWAA;
    ...
    :goto_0
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/WWAA;->x(I)V
...
.method public setSuggestionsAdapter(Ldef/OU;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/widget/SearchView;->f0:Ldef/OU;
