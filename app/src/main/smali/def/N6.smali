...
.method public bridge synthetic a()Ldef/JG;
    ...
    invoke-virtual {p0}, Ldef/N6;->d()Ldef/OZ1;
...
.method public d()Ldef/OZ1;
    .locals 2

    new-instance v0, Ldef/OZ1;

    iget-object v1, p0, Ldef/ZF;->a:Ljava/util/List;

    invoke-direct {v0, v1}, Ldef/OZ1;-><init>(Ljava/util/List;)V
