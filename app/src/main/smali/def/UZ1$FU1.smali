...
.method constructor <init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
    ...
    iput-object p1, p0, Ldef/UZ1$FU1;->a:Landroid/view/ActionMode$Callback;

    iput-object p2, p0, Ldef/UZ1$FU1;->b:Landroid/widget/TextView;

    const/4 p1, 0x0

    iput-boolean p1, p0, Ldef/UZ1$FU1;->f:Z
...
.method private b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
    ...
    invoke-direct {p0}, Ldef/UZ1$FU1;->a()Landroid/content/Intent;

    move-result-object v0

    invoke-direct {p0, p2}, Ldef/UZ1$FU1;->d(Landroid/widget/TextView;)Z
...
.method private c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    invoke-direct {p0, v1, p1}, Ldef/UZ1$FU1;->e(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
...
.method private f(Landroid/view/Menu;)V
    ...
    iget-object v0, p0, Ldef/UZ1$FU1;->b:Landroid/widget/TextView;
    ...
    iget-boolean v2, p0, Ldef/UZ1$FU1;->f:Z
    ...
    iput-boolean v5, p0, Ldef/UZ1$FU1;->f:Z
    ...
    iput-object v2, p0, Ldef/UZ1$FU1;->c:Ljava/lang/Class;
    ...
    iput-object v2, p0, Ldef/UZ1$FU1;->d:Ljava/lang/reflect/Method;

    iput-boolean v5, p0, Ldef/UZ1$FU1;->e:Z
    :try_end_0
    ...
    iput-boolean v4, p0, Ldef/UZ1$FU1;->e:Z

    :cond_0
    :goto_0
    :try_start_1
    iget-boolean v2, p0, Ldef/UZ1$FU1;->e:Z

    if-eqz v2, :cond_1

    iget-object v2, p0, Ldef/UZ1$FU1;->c:Ljava/lang/Class;
    ...
    iget-object v2, p0, Ldef/UZ1$FU1;->d:Ljava/lang/reflect/Method;
    ...
    :cond_3
    invoke-direct {p0, v0, v1}, Ldef/UZ1$FU1;->c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    iget-object v7, p0, Ldef/UZ1$FU1;->b:Landroid/widget/TextView;

    invoke-direct {p0, v3, v7}, Ldef/UZ1$FU1;->b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
...
.method public onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Ldef/UZ1$FU1;->a:Landroid/view/ActionMode$Callback;
...
.method public onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    invoke-direct {p0, p2}, Ldef/UZ1$FU1;->f(Landroid/view/Menu;)V
