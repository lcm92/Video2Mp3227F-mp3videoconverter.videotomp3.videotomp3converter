.class public abstract Ldef/C70;
...
.method private static a(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;)V
    ...
    invoke-static {p0, p1, v0, v1, v2}, Ldef/C70;->b(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
...
.method private static b(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-direct/range {v2 .. v7}, Ldef/C70$BC1;-><init>(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
...
.method public static c(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
    ...
    invoke-static {p0}, Ldef/C70;->d(Ljava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-static {v0, v1}, Ldef/C70;->e(Ljava/util/concurrent/ThreadFactory;Ljava/util/concurrent/RejectedExecutionHandler;)Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    invoke-static {p0, v0}, Ldef/C70;->a(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;)V
...
.method public static d(Ljava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    ...
    new-instance v1, Ldef/C70$AC1;

    invoke-direct {v1, p0, v0}, Ldef/C70$AC1;-><init>(Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicLong;)V
