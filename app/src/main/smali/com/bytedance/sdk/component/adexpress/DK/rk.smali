...
.method public static fFV(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    .line 41
    invoke-static/range {v1 .. v6}, Lwg2;->a(IIIIJ)Landroid/media/ImageReader;

    move-result-object v0

    .line 42
    invoke-static {}, Lih2;->a()V

    const-string v1, "BlurEffect"

    invoke-static {v1}, Lgh2;->a(Ljava/lang/String;)Landroid/graphics/RenderNode;
    ...
    invoke-static {}, Lhh2;->a()Landroid/graphics/HardwareRenderer;
    ...
    invoke-static {v2, v3}, Lrh2;->a(Landroid/graphics/HardwareRenderer;Landroid/view/Surface;)V

    .line 45
    invoke-static {v2, v1}, Lsh2;->a(Landroid/graphics/HardwareRenderer;Landroid/graphics/RenderNode;)V
    ...
    invoke-static {v1, v5, v5, v3, v4}, Lxg2;->a(Landroid/graphics/RenderNode;IIII)Z
    ...
    invoke-static {v3, v3, v4}, Lah2;->a(FFLandroid/graphics/Shader$TileMode;)Landroid/graphics/RenderEffect;

    move-result-object v3

    .line 48
    invoke-static {v1, v3}, Lbh2;->a(Landroid/graphics/RenderNode;Landroid/graphics/RenderEffect;)Z

    .line 49
    invoke-static {v1}, Lch2;->a(Landroid/graphics/RenderNode;)Landroid/graphics/RecordingCanvas;
    ...
    .line 50
    invoke-static {v3, p0, v5, v5, v4}, Ldh2;->a(Landroid/graphics/RecordingCanvas;Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V

    .line 51
    invoke-static {v1}, Leh2;->a(Landroid/graphics/RenderNode;)V

    .line 52
    invoke-static {v2}, Lfh2;->a(Landroid/graphics/HardwareRenderer;)Landroid/graphics/HardwareRenderer$FrameRenderRequest;

    move-result-object v3

    const/4 v5, 0x1

    invoke-static {v3, v5}, Ljh2;->a(Landroid/graphics/HardwareRenderer$FrameRenderRequest;Z)Landroid/graphics/HardwareRenderer$FrameRenderRequest;

    move-result-object v3

    invoke-static {v3}, Llh2;->a(Landroid/graphics/HardwareRenderer$FrameRenderRequest;)I
    ...
    .line 54
    invoke-static {v3}, Lmh2;->a(Landroid/media/Image;)Landroid/hardware/HardwareBuffer;

    move-result-object v5

    .line 55
    invoke-static {v5, v4}, Lnh2;->a(Landroid/hardware/HardwareBuffer;Landroid/graphics/ColorSpace;)Landroid/graphics/Bitmap;

    move-result-object v4

    .line 56
    invoke-static {v5}, Loh2;->a(Landroid/hardware/HardwareBuffer;)V
    ...
    .line 59
    invoke-static {v1}, Lph2;->a(Landroid/graphics/RenderNode;)V

    .line 60
    invoke-static {v2}, Lqh2;->a(Landroid/graphics/HardwareRenderer;)V
    :try_end_0
