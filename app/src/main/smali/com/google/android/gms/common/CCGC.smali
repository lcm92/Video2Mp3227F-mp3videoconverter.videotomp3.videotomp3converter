.class public abstract Lcom/google/android/gms/common/CCGC;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/CCGC;->sCanceledAvailabilityNotification:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/CCGC;->zzc:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static cancelAvailabilityErrorNotifications(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/google/android/gms/common/CCGC;->sCanceledAvailabilityNotification:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static enableUsingApkIndependentContext()V
    ...
    sget-object v0, Lcom/google/android/gms/common/CCGC;->zzc:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static ensurePlayServicesAvailable(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, p0, p1}, Lcom/google/android/gms/common/BCGC;->h(Landroid/content/Context;I)I
    ...
    invoke-virtual {v1, p0, p1, v0}, Lcom/google/android/gms/common/BCGC;->b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    new-instance p0, Ldef/PH0;

    invoke-direct {p0, p1}, Ldef/PH0;-><init>(I)V

    throw p0

    :cond_0
    new-instance v0, Ldef/QH0;

    const-string v1, "Google Play Services not available"

    invoke-direct {v0, p1, v1, p0}, Ldef/QH0;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static getClientVersion(Landroid/content/Context;)I
    ...
    invoke-static {v0}, Ldef/JD1;->p(Z)V

    invoke-virtual {p0}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v0

    invoke-static {p0, v0}, Ldef/DM;->a(Landroid/content/Context;Ljava/lang/String;)I
...
.method public static getGooglePlayServicesAvailabilityRecoveryIntent(I)Landroid/content/Intent;
    ...
    invoke-virtual {v0, v1, p0, v1}, Lcom/google/android/gms/common/BCGC;->b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public static honorsDebugCertificates(Landroid/content/Context;)Z
    ...
    sget-boolean v0, Lcom/google/android/gms/common/CCGC;->zza:Z
    ...
    invoke-static {v0, v1}, Lcom/google/android/gms/common/DCGC;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Lcom/google/android/gms/common/DCGC;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Lcom/google/android/gms/common/CCGC;->zzb:Z
    ...
    :cond_0
    sput-boolean v1, Lcom/google/android/gms/common/CCGC;->zzb:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :goto_0
    sput-boolean v2, Lcom/google/android/gms/common/CCGC;->zza:Z
    ...
    :cond_1
    :goto_3
    sget-boolean p0, Lcom/google/android/gms/common/CCGC;->zzb:Z

    if-nez p0, :cond_3

    invoke-static {}, Ldef/W00;->e()Z
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/CCGC;->isGooglePlayServicesAvailable(Landroid/content/Context;I)I
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;I)I
    ...
    sget-object v1, Lcom/google/android/gms/common/CCGC;->zzc:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    invoke-static {p0}, Ldef/HL2;->a(Landroid/content/Context;)I

    move-result v1

    if-eqz v1, :cond_2

    sget v3, Lcom/google/android/gms/common/CCGC;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I
    ...
    :cond_3
    :goto_1
    invoke-static {p0}, Ldef/W00;->g(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Ldef/W00;->i(Landroid/content/Context;)Z
    ...
    :goto_3
    invoke-static {v5}, Ldef/JD1;->a(Z)V
    ...
    invoke-static {v9, v3}, Lcom/google/android/gms/common/DCGC;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v8, v3}, Lcom/google/android/gms/common/DCGC;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Ldef/MK2;->a(I)I

    move-result p0

    invoke-static {p1}, Ldef/MK2;->a(I)I
...
.method public static isGooglePlayServicesUid(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Ldef/X42;->a(Landroid/content/Context;I)Z
...
.method public static isPlayServicesPossiblyUpdating(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lcom/google/android/gms/common/CCGC;->zza(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static isSidewinderDevice(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Ldef/W00;->d(Landroid/content/Context;)Z
...
.method public static uidHasPackageName(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, Ldef/X42;->b(Landroid/content/Context;ILjava/lang/String;)Z
...
.method static zza(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/CCGC;->isRestrictedUserProfile(Landroid/content/Context;)Z
