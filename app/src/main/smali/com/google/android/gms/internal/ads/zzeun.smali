...
.method public static synthetic zzc(Lcom/google/android/gms/internal/ads/zzeun;)Lcom/google/android/gms/internal/ads/zzeul;
    ...
    invoke-static {v2}, Ldef/W00;->c(Landroid/content/Context;)Z

    move-result v12

    invoke-static {v2}, Ldef/W00;->d(Landroid/content/Context;)Z
    ...
    invoke-static {}, Ldef/U41;->a()Landroid/os/LocaleList;
    ...
    :goto_0
    invoke-static {v4}, Ldef/UO2;->a(Landroid/os/LocaleList;)I

    move-result v8

    if-ge v9, v8, :cond_0

    invoke-static {v4, v9}, Ldef/JU0;->a(Landroid/os/LocaleList;I)Ljava/util/Locale;
    ...
    invoke-virtual {v2, v9, v7}, Ldef/R91;->f(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-virtual {v4, v7, v9}, Ldef/R91;->f(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    invoke-static {}, Ldef/VO2;->a()Ljava/lang/Class;
    ...
    invoke-static {v8}, Ldef/WO2;->a(Ljava/lang/Object;)Landroid/app/LocaleManager;

    move-result-object v8

    if-eqz v8, :cond_5

    invoke-static {v8}, Ldef/XO2;->a(Landroid/app/LocaleManager;)Landroid/os/LocaleList;

    move-result-object v7

    const/4 v9, 0x0

    invoke-static {v7, v9}, Ldef/JU0;->a(Landroid/os/LocaleList;I)Ljava/util/Locale;
    ...
    invoke-static {v7}, Ldef/Z7;->a(Landroid/content/res/Configuration;)Landroid/os/LocaleList;

    move-result-object v7

    const/4 v8, 0x0

    invoke-static {v7, v8}, Ldef/JU0;->a(Landroid/os/LocaleList;I)Ljava/util/Locale;
    ...
    invoke-virtual {v7, v0, v9}, Ldef/R91;->c(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
