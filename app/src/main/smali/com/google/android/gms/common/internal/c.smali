...
# direct methods
.method protected constructor <init>(Landroid/content/Context;Landroid/os/Looper;ILfm;Loh0$b;Loh0$c;)V
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p6}, Lcom/google/android/gms/common/internal/c;-><init>(Landroid/content/Context;Landroid/os/Looper;ILfm;Lrp;Ly71;)V

    return-void
.end method

.method protected constructor <init>(Landroid/content/Context;Landroid/os/Looper;ILfm;Lrp;Ly71;)V
    .locals 9
    ...
    .line 6
    invoke-direct/range {v0 .. v8}, Lcom/google/android/gms/common/internal/c;-><init>(Landroid/content/Context;Landroid/os/Looper;Lcom/google/android/gms/common/internal/d;Lcom/google/android/gms/common/a;ILfm;Lrp;Ly71;)V

    return-void
.end method

.method protected constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/google/android/gms/common/internal/d;Lcom/google/android/gms/common/a;ILfm;Lrp;Ly71;)V
    .locals 10
    ...
    invoke-direct {v3, v0}, Lcom/google/android/gms/common/internal/f;-><init>(Lrp;)V
    ...
    invoke-direct {v0, v1}, Lcom/google/android/gms/common/internal/g;-><init>(Ly71;)V

    move-object v7, v0

    .line 9
    :goto_1
    invoke-virtual/range {p6 .. p6}, Lfm;->i()Ljava/lang/String;
    ...
    iput-object v0, v9, Lcom/google/android/gms/common/internal/c;->zab:Lfm;

    .line 11
    invoke-virtual/range {p6 .. p6}, Lfm;->b()Landroid/accounts/Account;

    move-result-object v1

    iput-object v1, v9, Lcom/google/android/gms/common/internal/c;->zad:Landroid/accounts/Account;

    .line 12
    invoke-virtual/range {p6 .. p6}, Lfm;->d()Ljava/util/Set;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/google/android/gms/common/internal/c;->d(Ljava/util/Set;)Ljava/util/Set;
...
.method protected final getClientSettings()Lfm;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/google/android/gms/common/internal/c;->zab:Lfm;
