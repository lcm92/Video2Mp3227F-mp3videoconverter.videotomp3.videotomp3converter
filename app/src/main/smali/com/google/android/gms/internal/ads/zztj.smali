...
.method public static zza(Landroid/media/MediaCodecInfo$VideoCapabilities;IID)I
    ...
    invoke-static {p0}, Ldef/PU2;->a(Landroid/media/MediaCodecInfo$VideoCapabilities;)Ljava/util/List;
    ...
    invoke-static {p1, p2, p3}, Ldef/SU2;->a(III)Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;
...
.method private static zzb(Z)I
    ...
    invoke-static {v2}, Ldef/PU2;->a(Landroid/media/MediaCodecInfo$VideoCapabilities;)Ljava/util/List;
    ...
    invoke-static {v3, p0, v1}, Ldef/SU2;->a(III)Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;
...
.method private static zzc(Ljava/util/List;Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;)I
    ...
    invoke-static {v1}, Ldef/QU2;->a(Ljava/lang/Object;)Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;

    move-result-object v1

    invoke-static {v1, p1}, Ldef/RU2;->a(Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;Landroid/media/MediaCodecInfo$VideoCapabilities$PerformancePoint;)Z
