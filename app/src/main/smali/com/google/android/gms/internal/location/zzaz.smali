...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Ldef/OH0$BO1;Ldef/OH0$CO1;Ljava/lang/String;Ldef/FM;)V
    .locals 0

    invoke-direct/range {p0 .. p6}, Lcom/google/android/gms/internal/location/zzi;-><init>(Landroid/content/Context;Landroid/os/Looper;Ldef/OH0$BO1;Ldef/OH0$CO1;Ljava/lang/String;Ldef/FM;)V
...
.method public final disconnect()V
    ...
    :cond_0
    :goto_0
    invoke-super {p0}, Lcom/google/android/gms/common/internal/BICC;->disconnect()V
...
.method public final zzB(Lcom/google/android/gms/internal/location/zzba;Lcom/google/android/gms/common/api/internal/DIAC;Lcom/google/android/gms/internal/location/zzai;)V
    .locals 2
    ...
    invoke-virtual {v1, p1, p2, p3}, Lcom/google/android/gms/internal/location/zzav;->zze(Lcom/google/android/gms/internal/location/zzba;Lcom/google/android/gms/common/api/internal/DIAC;Lcom/google/android/gms/internal/location/zzai;)V
...
.method public final zzC(Lcom/google/android/gms/location/LocationRequest;Lcom/google/android/gms/common/api/internal/DIAC;Lcom/google/android/gms/internal/location/zzai;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1, p1, p2, p3}, Lcom/google/android/gms/internal/location/zzav;->zzd(Lcom/google/android/gms/location/LocationRequest;Lcom/google/android/gms/common/api/internal/DIAC;Lcom/google/android/gms/internal/location/zzai;)V
...
.method public final zzF(Lcom/google/android/gms/common/api/internal/DIAC$AD1;Lcom/google/android/gms/internal/location/zzai;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1, p2}, Lcom/google/android/gms/internal/location/zzav;->zzh(Lcom/google/android/gms/common/api/internal/DIAC$AD1;Lcom/google/android/gms/internal/location/zzai;)V
...
.method public final zzH(Lcom/google/android/gms/common/api/internal/DIAC$AD1;Lcom/google/android/gms/internal/location/zzai;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1, p2}, Lcom/google/android/gms/internal/location/zzav;->zzi(Lcom/google/android/gms/common/api/internal/DIAC$AD1;Lcom/google/android/gms/internal/location/zzai;)V
...
.method public final zzL(Lcom/google/android/gms/location/LocationSettingsRequest;Ldef/HG;Ljava/lang/String;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1, v2}, Ldef/JD1;->b(ZLjava/lang/Object;)V
    ...
    invoke-static {p3, v0}, Ldef/JD1;->b(ZLjava/lang/Object;)V

    new-instance p3, Lcom/google/android/gms/internal/location/zzay;

    invoke-direct {p3, p2}, Lcom/google/android/gms/internal/location/zzay;-><init>(Ldef/HG;)V

    invoke-virtual {p0}, Lcom/google/android/gms/common/internal/BICC;->getService()Landroid/os/IInterface;
...
.method public final zzr(Lcom/google/android/gms/location/ActivityTransitionRequest;Landroid/app/PendingIntent;Ldef/HG;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v0, Ldef/DU1;

    invoke-direct {v0, p3}, Ldef/DU1;-><init>(Ldef/HG;)V
    ...
    invoke-interface {p3, p1, p2, v0}, Lcom/google/android/gms/internal/location/zzam;->zzi(Lcom/google/android/gms/location/ActivityTransitionRequest;Landroid/app/PendingIntent;Ldef/PL0;)V

    return-void
.end method

.method public final zzs(Landroid/app/PendingIntent;Ldef/HG;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p2}, Ldef/DU1;-><init>(Ldef/HG;)V
    ...
    invoke-interface {p2, p1, v0}, Lcom/google/android/gms/internal/location/zzam;->zzj(Landroid/app/PendingIntent;Ldef/PL0;)V
...
.method public final zzu(Landroid/app/PendingIntent;Ldef/HG;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, p1, v0}, Lcom/google/android/gms/internal/location/zzam;->zzl(Landroid/app/PendingIntent;Ldef/PL0;)V

    return-void
.end method

.method public final zzv(Lcom/google/android/gms/location/GeofencingRequest;Landroid/app/PendingIntent;Ldef/HG;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p3}, Lcom/google/android/gms/internal/location/zzaw;-><init>(Ldef/HG;)V
...
.method public final zzw(Lcom/google/android/gms/location/zzbq;Ldef/HG;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p2}, Lcom/google/android/gms/internal/location/zzax;-><init>(Ldef/HG;)V
...
.method public final zzx(Landroid/app/PendingIntent;Ldef/HG;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final zzy(Ljava/util/List;Ldef/HG;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p2, v1}, Ldef/JD1;->m(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final zzz(Ljava/lang/String;)Landroid/location/Location;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/internal/BICC;->getAvailableFeatures()[Lcom/google/android/gms/common/Feature;

    move-result-object v0

    sget-object v1, Ldef/WU2;->c:Lcom/google/android/gms/common/Feature;

    invoke-static {v0, v1}, Ldef/EA;->c([Ljava/lang/Object;Ljava/lang/Object;)Z
