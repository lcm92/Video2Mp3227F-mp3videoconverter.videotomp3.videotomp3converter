...
.method private c(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/Long;)Lorg/json/JSONObject;
    ...
    invoke-static {p1}, Ldef/O91;->a(Landroid/content/pm/PackageInfo;)J
    ...
    invoke-direct {p1, p2}, Ldef/UB0;-><init>(Ljava/lang/String;)V

    throw p1
.end method

.method private static e(Lorg/json/JSONObject;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/BIRC;
    .locals 2

    :try_start_0
    invoke-static {}, Lcom/google/firebase/remoteconfig/internal/BIRC;->g()Lcom/google/firebase/remoteconfig/internal/BIRC$BB1;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/google/firebase/remoteconfig/internal/BIRC$BB1;->d(Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/BIRC$BB1;
    ...
    :try_start_2
    invoke-virtual {p1, v1}, Lcom/google/firebase/remoteconfig/internal/BIRC$BB1;->b(Lorg/json/JSONObject;)Lcom/google/firebase/remoteconfig/internal/BIRC$BB1;
    :try_end_2
    ...
    :try_start_4
    invoke-virtual {p1, v1}, Lcom/google/firebase/remoteconfig/internal/BIRC$BB1;->c(Lorg/json/JSONArray;)Lcom/google/firebase/remoteconfig/internal/BIRC$BB1;
    :try_end_4
    ...
    :try_start_6
    invoke-virtual {p1, v0}, Lcom/google/firebase/remoteconfig/internal/BIRC$BB1;->e(Lorg/json/JSONObject;)Lcom/google/firebase/remoteconfig/internal/BIRC$BB1;

    :cond_2
    invoke-virtual {p1}, Lcom/google/firebase/remoteconfig/internal/BIRC$BB1;->a()Lcom/google/firebase/remoteconfig/internal/BIRC;
    ...
    invoke-direct {p1, v0, p0}, Ldef/UB0;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method d()Ljava/net/HttpURLConnection;
    ...
    new-instance v1, Ldef/VB0;

    invoke-virtual {v0}, Ljava/lang/Throwable;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Ldef/VB0;-><init>(Ljava/lang/String;)V

    throw v1
.end method

.method fetch(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Ljava/lang/Long;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/CIRC$AC1;
    .locals 0
    ...
    invoke-static {p8}, Lcom/google/firebase/remoteconfig/internal/CIRC$AC1;->a(Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/CIRC$AC1;
    ...
    :cond_0
    invoke-static {p3, p8}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->e(Lorg/json/JSONObject;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/BIRC;

    move-result-object p1

    invoke-static {p1, p2}, Lcom/google/firebase/remoteconfig/internal/CIRC$AC1;->b(Lcom/google/firebase/remoteconfig/internal/BIRC;Ljava/lang/String;)Lcom/google/firebase/remoteconfig/internal/CIRC$AC1;
    ...
    :cond_1
    :try_start_2
    new-instance p3, Ldef/XB0;

    invoke-virtual {p1}, Ljava/net/HttpURLConnection;->getResponseMessage()Ljava/lang/String;

    move-result-object p4

    invoke-direct {p3, p2, p4}, Ldef/XB0;-><init>(ILjava/lang/String;)V
    ...
    :goto_0
    :try_start_3
    new-instance p3, Ldef/UB0;

    const-string p4, "The client had an error while calling the backend!"

    invoke-direct {p3, p4, p2}, Ldef/UB0;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
