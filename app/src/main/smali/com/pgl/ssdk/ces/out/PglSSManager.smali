...
# instance fields
.field private final b:Lcom/pgl/ssdk/ces/BCSC;
...
.method private constructor <init>(Landroid/content/Context;Lcom/pgl/ssdk/ces/out/PglSSConfig;)V
    ...
    invoke-static {p1, v0, v1, v2, p2}, Lcom/pgl/ssdk/ces/BCSC;->a(Landroid/content/Context;Ljava/lang/String;IILjava/lang/String;)Lcom/pgl/ssdk/ces/BCSC;

    move-result-object p1

    iput-object p1, p0, Lcom/pgl/ssdk/ces/out/PglSSManager;->b:Lcom/pgl/ssdk/ces/BCSC;
...
.method public static getInitStatus()I
    ...
    invoke-static {}, Lcom/pgl/ssdk/ces/BCSC;->g()I
...
.method public static getLoadError()Ljava/lang/String;
    ...
    invoke-static {}, Lcom/pgl/ssdk/ces/BCSC;->i()Lcom/pgl/ssdk/W0SPC$AW1;
    ...
    iget-object v0, v0, Lcom/pgl/ssdk/W0SPC$AW1;->b:Ljava/lang/String;
...
.method public static init(Landroid/content/Context;Lcom/pgl/ssdk/ces/out/PglSSConfig;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/pgl/ssdk/ces/out/PglSSManager;
    ...
    iget-object p0, p0, Lcom/pgl/ssdk/ces/out/PglSSManager;->b:Lcom/pgl/ssdk/ces/BCSC;

    invoke-virtual {p1}, Lcom/pgl/ssdk/ces/out/PglSSConfig;->getCustomInfo()Ljava/util/Map;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/pgl/ssdk/ces/BCSC;->a(Ljava/util/Map;)V

    sget-object p0, Lcom/pgl/ssdk/ces/out/PglSSManager;->a:Lcom/pgl/ssdk/ces/out/PglSSManager;

    iget-object p0, p0, Lcom/pgl/ssdk/ces/out/PglSSManager;->b:Lcom/pgl/ssdk/ces/BCSC;

    invoke-virtual {p0, p2, p4, p3, p5}, Lcom/pgl/ssdk/ces/BCSC;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public checkEventVirtual(Landroid/view/MotionEvent;)V
    ...
    iget-object v0, p0, Lcom/pgl/ssdk/ces/out/PglSSManager;->b:Lcom/pgl/ssdk/ces/BCSC;

    invoke-virtual {v0, p1}, Lcom/pgl/ssdk/ces/BCSC;->a(Landroid/view/MotionEvent;)V
...
.method public getECForBidding()J
    ...
    invoke-virtual {v0}, Lcom/pgl/ssdk/ces/BCSC;->e()J
...
.method public getFeatureHash(Ljava/lang/String;[B)Ljava/util/Map;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/pgl/ssdk/ces/BCSC;->a(Ljava/lang/String;[B)Ljava/util/Map;
...
.method public getSofChara()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/pgl/ssdk/ces/BCSC;->j()Ljava/lang/String;
...
.method public getToken()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/pgl/ssdk/ces/BCSC;->k()Ljava/lang/String;
...
.method public reportNow(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-virtual {v0}, Lcom/pgl/ssdk/ces/BCSC;->b()V

    :cond_0
    iget v0, p0, Lcom/pgl/ssdk/ces/out/PglSSManager;->c:I

    iget-object v1, p0, Lcom/pgl/ssdk/ces/out/PglSSManager;->b:Lcom/pgl/ssdk/ces/BCSC;

    iget v2, v1, Lcom/pgl/ssdk/ces/BCSC;->p:I

    rem-int/2addr v0, v2

    if-nez v0, :cond_1

    invoke-virtual {v1, p1, p2}, Lcom/pgl/ssdk/ces/BCSC;->a(Ljava/lang/String;Ljava/util/Map;)V
...
.method public setCustomInfo(Ljava/util/Map;)V
    ...
    invoke-virtual {v0, p1}, Lcom/pgl/ssdk/ces/BCSC;->a(Ljava/util/Map;)V
...
.method public setDeviceId(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/pgl/ssdk/ces/BCSC;->b(Ljava/lang/String;)V
...
.method public setGaid(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/pgl/ssdk/ces/BCSC;->c(Ljava/lang/String;)V
