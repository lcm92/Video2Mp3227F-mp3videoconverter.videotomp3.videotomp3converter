...
.method bridge synthetic i(Ljr0;F)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lrc0;->r(Ljr0;F)Ljava/lang/Float;
...
.method public p()F
    ...
    .line 9
    invoke-virtual {p0, v0, v1}, Lrc0;->q(Ljr0;F)F
...
.method q(Ljr0;F)F
    ...
    .line 53
    :cond_0
    invoke-virtual {p1}, Ljr0;->f()F

    .line 56
    move-result v0

    .line 57
    invoke-virtual {p1}, Ljr0;->c()F

    .line 60
    move-result p1

    .line 61
    invoke-static {v0, p1, p2}, Lb31;->i(FFF)F
...
.method r(Ljr0;F)Ljava/lang/Float;
    .locals 0

    .line 1
    invoke-virtual {p0, p1, p2}, Lrc0;->q(Ljr0;F)F
