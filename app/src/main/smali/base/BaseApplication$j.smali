.class public final Lbase/BaseApplication$j;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lbase/BaseApplication$c;

    const-class v1, Lbase/BaseApplication$b;

    const-class v2, Lbase/BaseApplication$h;

    new-instance v3, Ljava/util/HashSet;

    invoke-direct {v3}, Ljava/util/HashSet;-><init>()V

    sput-object v3, Lbase/BaseApplication$j;->f:Ljava/util/HashSet;
    ...
    sput-object v3, Lbase/BaseApplication$j;->a:Lsun/misc/Unsafe;
    ...
    sput-wide v6, Lbase/BaseApplication$j;->b:J
    ...
    const-class v0, Lbase/BaseApplication$f;
    ...
    const-class v0, Lbase/BaseApplication$g;
    ...
    sput-wide v8, Lbase/BaseApplication$j;->c:J
    ...
    const-class v0, Lbase/BaseApplication$d;
    ...
    invoke-static {}, Lbase/BaseApplication$i;->c()Ljava/lang/invoke/MethodHandles$Lookup;

    move-result-object v5

    invoke-static {v5, v0}, Lbase/BaseApplication$i;->b(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/reflect/Method;)Ljava/lang/invoke/MethodHandle;
    ...
    invoke-static {v5, v1}, Lbase/BaseApplication$i;->b(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/reflect/Method;)Ljava/lang/invoke/MethodHandle;
    ...
    sput-wide v0, Lbase/BaseApplication$j;->d:J

    sub-long/2addr v12, v8

    sub-long/2addr v12, v0

    sput-wide v12, Lbase/BaseApplication$j;->e:J
    ...
    invoke-static {v4, v0}, Lbase/BaseApplication$i;->a(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/reflect/Field;)Ljava/lang/invoke/MethodHandle;
    ...
    invoke-static {v4, v1}, Lbase/BaseApplication$i;->a(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/reflect/Field;)Ljava/lang/invoke/MethodHandle;
...
.method public static varargs a(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-class v5, Lbase/BaseApplication$e;
    ...
    sget-object v5, Lbase/BaseApplication$j;->a:Lsun/misc/Unsafe;

    sget-wide v6, Lbase/BaseApplication$j;->c:J
    ...
    sget-wide v9, Lbase/BaseApplication$j;->d:J

    mul-long v7, v7, v9

    add-long/2addr v7, v13

    sget-wide v9, Lbase/BaseApplication$j;->e:J

    add-long v11, v7, v9

    sget-object v7, Lbase/BaseApplication$j;->a:Lsun/misc/Unsafe;

    sget-wide v9, Lbase/BaseApplication$j;->b:J
...
.method public static varargs b([Ljava/lang/String;)Z
    ...
    invoke-static {v3, v6, v4, v5}, Lbase/BaseApplication$j;->a(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v4, v3, v2, v5}, Lbase/BaseApplication$j;->a(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
